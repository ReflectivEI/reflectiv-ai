/**
 * Product Knowledge Mode Controller
 * Backend mode: "product-knowledge"
 * Workflow: Disease + HCP selection → product knowledge Q&A
 * Handles per-mode history and product-specific payload building
 */
import { chat } from '../core/api.js';

const MODE = 'product-knowledge';
const history = [];
